# -*- coding: utf-8 -*-
"""Flan_T5_LoRA_Training.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1TyNo1Sd7DJwbqSaYT4EKMTLhi_RJG1rD
"""
...
!ls -R /content/drive/MyDrive/text2sql/logs/t5_large_sql_types_schema_v3_nofp16/

# Commented out IPython magic to ensure Python compatibility.
# %tensorboard --logdir /content/drive/MyDrive/text2sql/logs/t5_large_sql_types_schema_v3_nofp16
...
LOAD_IN_4BIT = True      # Whether to load model in 4-bit quantization

# 2)  TRAINING HYPER-PARAMS
EPOCHS                     = 6
LEARNING_RATE              = 2e-4  # Slightly higher for LoRA
BATCH_SIZE                 = 4     # Can be increased with LoRA
