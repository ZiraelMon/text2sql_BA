# -*- coding: utf-8 -*-
"""DeepSeek_Training-v1.4.2.ipynb
...
# ----- OPTIONAL one-shot dev evaluation -----
# Uncomment the four lines below if you still want a quick dev run.
# eval_metrics = trainer.evaluate(tokenized_dev)
# trainer.log_metrics("eval", eval_metrics)
# trainer.save_metrics("eval", eval_metrics)
# print("Final dev metrics:", eval_metrics)
