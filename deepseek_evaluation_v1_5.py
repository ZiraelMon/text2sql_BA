# -*- coding: utf-8 -*-
"""DeepSeek_Evaluation-v1.5.ipynb
...
print(f"Gold file exists: {os.path.exists('/content/drive/MyDrive/text2sql/eval_results/deepseek_coder_6.7b_lora_v1.5/gold_sql.txt')}")
print(f"Pred file exists: {os.path.exists('/content/drive/MyDrive/text2sql/eval_results/deepseek_coder_6.7b_lora_v1.5/pred_sql.txt')}")
...
!python /content/spider-eval/evaluation.py --gold /content/drive/MyDrive/text2sql/eval_results/deepseek_coder_6.7b_lora_v1.5/gold_sql.txt --pred /content/drive/MyDrive/text2sql/eval_results/deepseek_coder_6.7b_lora_v1.5/pred_sql.txt --db /content/drive/MyDrive/text2sql/datasets/spider/database --table /content/drive/MyDrive/text2sql/datasets/spider/tables.json --etype all

# Evaluation script with proper path handling for DeepSeek-Coder model
# This combines necessary path fixes with the evaluation improvements
...
MAX_NEW_TOKENS   = 256
GEN_BATCH        = 4
BEAM_SIZE        = 4  # Using beam search with 4 beams
SAVE_EVERY       = 100
